...
# a variable for a user’s first name might be called firstName, and a variable for a user’s 
...
# camel case and outputs the corresponding name in snake case. Assume that the user’s input will indeed be in camel case.
